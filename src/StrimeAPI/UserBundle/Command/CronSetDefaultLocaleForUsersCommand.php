...
class CronSetDefaultLocaleForUsersCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('cron:users:set-default-locale')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln( "[".date("Y-m-d H:i:s")."] Get all the users with an empty locale field" );
        $users = $em->getRepository('StrimeAPIUserBundle:User')->findBy(array("locale" => NULL));
