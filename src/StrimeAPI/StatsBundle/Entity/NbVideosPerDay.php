<?php
     ...
     * @ORM\Table(name="api_stats_nb_videos_per_day")
     */
    class NbVideosPerDay
    {
        /**
         * @ORM\Id
        ...
        /**
         * @ORM\Column(name="total_nb_videos", type="integer", nullable=false)
         */
        protected $total_nb_videos = 0;
        ...
        /**
         * @param integer $total_nb_videos
         * @return NbVideosPerDay
         */
        public function setTotalNbVideos($total_nb_videos) {
            $this->total_nb_videos = $total_nb_videos;
            return $this;
        }
         ...
         * @return integer
         */
        public function getTotalNbVideos() {
            return $this->total_nb_videos;
        }
