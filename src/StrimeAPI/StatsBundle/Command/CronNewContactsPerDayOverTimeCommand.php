...
class CronNewContactsPerDayOverTimeCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('cron:stats:new-contacts-per-day-over-time')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        while( new \DateTime() > $to_date ) {
            ...
            if($stats == NULL) {
                ...
                // Set the new total of contacts
                $total_nb_contacts += $nb_contacts;
